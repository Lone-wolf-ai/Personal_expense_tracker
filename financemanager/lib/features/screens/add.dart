...
class _Add_ScreenState extends State<Add_Screen> {
  ...
  final List imglist=[Img.food,Img.cre,Img.tran,Img.edu];
  ...
  GestureDetector _save() {
    return GestureDetector(
      onTap: () {
        var add=Add_data(name: selectedItem!, explain: expalin_C.text, amount: amount_c.text, IN: selectedItemi!, datetime: date);
        box.add(add);
  ...
  Widget _dateTime() {
    return Container(
      ...
      child: TextButton(
        onPressed: () async {
          // Add your date time picker logic here
        },
        child: Text(
    ...
    child: Container(
      ...
      child: DropdownButton<String>(
        ...
        items: _item
            ...
            .toList(),
        selectedItemBuilder: (BuildContext context) => _item.asMap().entries
            .map((e) => Row(
                  children: [
                    SizedBox(
                      width: 42,
                    child: Image.asset(imglist[e.key]),
                    ),
